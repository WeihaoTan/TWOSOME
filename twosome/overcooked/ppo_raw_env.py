...
def parse_args():
    ...
    parser.add_argument('--env-id',                 action='store',        type=str,             default='Overcooked-MA-v4',    help='Domain name')
    ...
    parser.add_argument('--obs-radius',             action='store',        type=int,             default=10,                     help='The radius of the agents')
...
if __name__ == "__main__":
    ...
    rewardList = {"subtask finished": 0.1, "correct delivery": 1, "wrong delivery": -0.1, "step penalty": -0.001}
